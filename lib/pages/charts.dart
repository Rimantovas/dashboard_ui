...
class _LineChartSample2State extends State<LineChartSample2> {
  List<Color> gradientColors = [
    const Color(0xffc89be0),
    const Color(0xff7100ad),
  ];
...
class BarChartSample2State extends State<BarChartSample2> {
  ...
  void initState() {
    ...
    final barGroup2 = makeGroupData(1, 12, 12);
    final barGroup3 = makeGroupData(2, 16, 8);
    final barGroup4 = makeGroupData(3, 10, 6);
    final barGroup5 = makeGroupData(4, 17, 15);
    final barGroup6 = makeGroupData(5, 19, 9);
    final barGroup7 = makeGroupData(6, 10, 8);
